    ...
    <body>
        <div class="content-wrapper">
            ...
            <section class="content-header"><!-- Content Header (Page header) -->
                ...
                <ul class="top-links">
                    ...
                    <sec:access url="/emsStaffAcademicSubject/edit/${emsStaffAcademicSubjectInstance?.id}">
                        <li>
                            <g:link class="btn btn-xs btn-block btn-warning" action="edit" id="${emsStaffAcademicSubjectInstance?.id}">
                    ...
                    <sec:access url="/emsStaffAcademicSubject/delete/${emsStaffAcademicSubjectInstance?.id}">
                        <li>
                            <g:link class="btn btn-xs btn-block btn-danger" action="delete" id="${emsStaffAcademicSubjectInstance?.id}" onclick="return confirm('Are you sure you want to delete this record?');">
            ...
            <section class="content show-page"><!-- Main content -->
                <fieldset class="emsStaffAcademicSubject-show">
                    <div class="box box-primary">
                        <div class="box-body">
                            <div class="property-show">

                                %{--<g:if test="${emsStaffAcademicSubjectInstance?.emsSubject}">--}%
                                <div class="form-group">
                                    <div class="col-xs-12 col-sm-4 col-md-3 col-lg-3">
                                        <span class="property-label bold">
                                            <g:message code="emsStaffAcademicSubject.emsSubject.label" default="Ems Subject"/>
                                        </span>
                                    </div>

                                    <div class="col-xs-12 col-sm-8 col-md-9 col-lg-9">
                                        <span class="property-value">
                                            <g:fieldValue bean="${emsStaffAcademicSubjectInstance}" field="emsSubject"/>&nbsp;
                                        </span>
                                    </div>
                                </div>
                                %{--</g:if>--}%
