            ...
            <section class="content-header"><!-- Content Header (Page header) -->
                ...
                <ul class="top-links">
                    ...
                    <sec:access url="/authLandingPage/delete/${authLandingPageInstance?.id}">
                        <li>
                            <g:link class="btn btn-xs btn-block btn-danger" action="delete" id="${authLandingPageInstance?.id}" onclick="return confirm('Are you sure you want to delete this record?');">
                    ...
                    <div class="box box-primary">
                        <div class="box-body">
                            <div class="property-show">
                                ...
                                %{--<g:if test="${authLandingPageInstance?.pageUrl}">--}%
                                <div class="form-group">
                                    <div class="col-xs-12 col-sm-4 col-md-3 col-lg-3">
                                        <span class="property-label bold">
                                            <g:message code="authLandingPage.pageUrl.label" default="Page Url"/>
                                        </span>
                                    </div>

                                    <div class="col-xs-12 col-sm-8 col-md-9 col-lg-9">
                                        <span class="property-value">
                                            <g:fieldValue bean="${authLandingPageInstance}" field="pageUrl"/>&nbsp;
                                        </span>
                                    </div>
                                </div>
                                %{--</g:if>--}%
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-12 col-sm-8 col-md-9 col-lg-9">
                                        <span class="property-value">
                                            <g:formatBoolean boolean="${authLandingPageInstance?.isActive}"/>&nbsp;
                                        </span>
                                    </div>
                                </div>
                                %{--</g:if>--}%
