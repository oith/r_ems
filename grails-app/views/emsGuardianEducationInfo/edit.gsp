    ...
    <body>
        <div class="content-wrapper"><!-- Content Wrapper. Contains page content -->
            <section class="content-header"><!-- Content Header (Page header) -->
                ...
                <ul class="top-links">
                    <sec:access url="/emsGuardianEducationInfo/index">
                        <li>
            ...
            <section class="content"><!-- Main content -->
                <div id="edit-emsGuardianEducationInfo" class="box box-primary" role="main">
                    <g:form url="[resource: emsGuardianEducationInfoInstance, action: 'update']" method="PUT" >
                        <div class="box-body">
                            <g:hiddenField name="version" value="${emsGuardianEducationInfoInstance?.version}" />
                            <g:render template="form" model="${[emsGuardianEducationInfoInstance:emsGuardianEducationInfoInstance]}"/>
                        </div><!-- /.box-body -->
                        <div class="box-footer">
                            <fieldset class="buttons">
                                ...
                                <sec:access url="/emsGuardianEducationInfo/show/${emsGuardianEducationInfoInstance?.id}">
                                    <g:link class="btn btn-warning pull-right" action="show" id="${emsGuardianEducationInfoInstance?.id}"><i class="fa fa-reply-all" aria-hidden="true"></i> ${message(code: "default.button.goBack.label", default: "Go Back")}</g:link>
                                </sec:access>
                            </fieldset>
                        </div><!-- /.box-footer -->
                    </g:form>
