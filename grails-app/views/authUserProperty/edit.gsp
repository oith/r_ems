    ...
    <body>
        <div class="content-wrapper"><!-- Content Wrapper. Contains page content -->
            ...
            <section class="content"><!-- Main content -->
                <div id="edit-authUserProperty" class="box box-primary" role="main">
                    <g:form url="[resource: authUserPropertyInstance, action: 'update']" method="PUT" >
                        <div class="box-body">
                            <g:hiddenField name="version" value="${authUserPropertyInstance?.version}" />
                            <g:render template="form" model="${[authUserPropertyInstance:authUserPropertyInstance]}"/>
                        </div><!-- /.box-body -->
                        <div class="box-footer">
                            <fieldset class="buttons">
                                ...
                                <sec:access url="/authUserProperty/show/${authUserPropertyInstance?.id}">
                                    <g:link class="btn btn-warning pull-right" action="show" id="${authUserPropertyInstance?.id}"><i class="fa fa-reply-all" aria-hidden="true"></i> ${message(code: "default.button.goBack.label", default: "Go Back")}</g:link>
                                </sec:access>
                            </fieldset>
                        </div><!-- /.box-footer -->
                    </g:form>
