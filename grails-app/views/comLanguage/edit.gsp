    ...
    <body>
        <div class="content-wrapper"><!-- Content Wrapper. Contains page content -->
            ...
            <section class="content"><!-- Main content -->
                <div id="edit-comLanguage" class="box box-primary" role="main">
                    <g:form url="[resource: comLanguageInstance, action: 'update']" method="PUT" >
                        <div class="box-body">
                            <g:hiddenField name="version" value="${comLanguageInstance?.version}" />
                            <g:render template="form" model="${[comLanguageInstance:comLanguageInstance]}"/>
                        </div><!-- /.box-body -->
                        <div class="box-footer">
                            <fieldset class="buttons">
                                ...
                                <sec:access url="/comLanguage/show/${comLanguageInstance?.id}">
                                    <g:link class="btn btn-warning pull-right" action="show" id="${comLanguageInstance?.id}"><i class="fa fa-reply-all" aria-hidden="true"></i> ${message(code: "default.button.goBack.label", default: "Go Back")}</g:link>
                                </sec:access>
                            </fieldset>
                        </div><!-- /.box-footer -->
                    </g:form>
