    ...
    <body>
        <div class="content-wrapper"><!-- Content Wrapper. Contains page content -->
            <section class="content-header"><!-- Content Header (Page header) -->
                ...
                <ul class="top-links">
                    <sec:access url="/comTraining/index">
                        <li>
            ...
            <section class="content"><!-- Main content -->
                <div id="edit-comTraining" class="box box-primary" role="main">
                    <g:form url="[resource: comTrainingInstance, action: 'update']" method="PUT" >
                        <div class="box-body">
                            <g:hiddenField name="version" value="${comTrainingInstance?.version}" />
                            <g:render template="form" model="${[comTrainingInstance:comTrainingInstance]}"/>
                        </div><!-- /.box-body -->
                        <div class="box-footer">
                            <fieldset class="buttons">
                                ...
                                <sec:access url="/comTraining/show/${comTrainingInstance?.id}">
                                    <g:link class="btn btn-warning pull-right" action="show" id="${comTrainingInstance?.id}"><i class="fa fa-reply-all" aria-hidden="true"></i> ${message(code: "default.button.goBack.label", default: "Go Back")}</g:link>
                                </sec:access>
                            </fieldset>
                        </div><!-- /.box-footer -->
                    </g:form>
