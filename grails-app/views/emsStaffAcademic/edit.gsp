    ...
    <body>
        <div class="content-wrapper"><!-- Content Wrapper. Contains page content -->
            ...
            <section class="content"><!-- Main content -->
                <div id="edit-emsStaffAcademic" class="box box-primary" role="main">
                    <g:form url="[resource: emsStaffAcademicInstance, action: 'update']" method="PUT" >
                        <div class="box-body">
                            <g:hiddenField name="version" value="${emsStaffAcademicInstance?.version}" />
                        ...
                        <div class="box-footer">
                            <fieldset class="buttons">
                                ...
                                <sec:access url="/emsStaffAcademic/show/${emsStaffAcademicInstance?.id}">
                                    <g:link class="btn btn-warning pull-right" action="show" id="${emsStaffAcademicInstance?.id}"><i class="fa fa-reply-all" aria-hidden="true"></i> ${message(code: "default.button.goBack.label", default: "Go Back")}</g:link>
                                </sec:access>
                            </fieldset>
                        </div><!-- /.box-footer -->
                    </g:form>
