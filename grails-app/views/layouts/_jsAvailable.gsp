...
<script type="text/javascript">
    ...
    var fDt                   = "${grailsApplication.config.format.dtp.dateTime}"; // 'dd/MM/yyyy HH:mm'
...
<!-- jquery-webcam.js -->
<script type="text/javascript" src="${resource(dir: "resources/plugins/webcam", file: "webcam.js")}"></script>
...
<script type="text/javascript" src="${resource(dir: "resources/plugins/reflection", file: "toggle-full-screen.js")}"></script>
<script type="text/javascript" src="${resource(dir: "resources/plugins/reflection", file: "custom-master-details.js")}"></script>
...
<script type="text/javascript" src="${resource(dir: "resources/plugins/reflection", file: "custom-file-upload.js")}"></script>
...
<script type="text/javascript" src="${resource(dir: 'resources/js/com', file: 'filterLocationHierarchy.js')}"></script>
