                ...
                <li><!-- start message -->
                    <a href="#">
                        <div class="pull-left">
                            ...
                            %{--<img src="${applicationContext.springSecurityService?.currentUser?.username == "saif_hmk" ?resource(dir: "resources/images/user", file: "saif_khan.jpg"):(resource(dir: "resources/images/", file: "biman_logo.png"))}" class="img-circle" alt="User Image">--}%
                        </div>
                        <h4>
