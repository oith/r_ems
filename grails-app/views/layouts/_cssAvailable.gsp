...
<link rel="stylesheet" type="text/css" href="${resource(dir: "resources/plugins/bootstrap-datetimepicker", file: "bootstrap-datetimepicker.css")}">
<!-- fullCalendar 2.2.5-->
...
<!-- DataTables -->
%{--<link rel="stylesheet" type="text/css" href="${resource(dir: "resources/plugins/datatables", file: "jquery.dataTables.css")}"/>--}%
...
<link rel="stylesheet" type="text/css" href="${resource(dir: "resources/plugins/reflection", file: "custom-input.css")}">
