    ...
    <body>
        <div class="content-wrapper"><!-- Content Wrapper. Contains page content -->
            ...
            <section class="content"><!-- Main content -->
                <div id="create-emsStaffAcademicContactInfo" class="box box-primary" role="main">
                    <g:form url="[resource: emsStaffAcademicContactInfoInstance, action: 'save']" method="POST" >
                        <div class="box-body">
