    ...
    <body>
        <div class="content-wrapper"><!-- Content Wrapper. Contains page content -->
            ...
            <section class="content"><!-- Main content -->
                <div id="edit-emsMarks" class="box box-primary" role="main">
                    <g:form url="[resource: emsMarksInstance, action: 'update']" method="PUT" >
                        <div class="box-body">
                            <g:hiddenField name="version" value="${emsMarksInstance?.version}" />
                            <g:render template="form" model="${[emsMarksInstance:emsMarksInstance]}"/>
                        </div><!-- /.box-body -->
                        <div class="box-footer">
                            <fieldset class="buttons">
                                ...
                                <sec:access url="/emsMarks/show/${emsMarksInstance?.id}">
                                    <g:link class="btn btn-warning pull-right" action="show" id="${emsMarksInstance?.id}"><i class="fa fa-reply-all" aria-hidden="true"></i> ${message(code: "default.button.goBack.label", default: "Go Back")}</g:link>
                                </sec:access>
                            </fieldset>
                        </div><!-- /.box-footer -->
                    </g:form>
