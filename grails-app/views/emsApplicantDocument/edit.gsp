    ...
    <body>
        <div class="content-wrapper"><!-- Content Wrapper. Contains page content -->
            ...
            <section class="content"><!-- Main content -->
                <div id="edit-emsApplicantDocument" class="box box-primary" role="main">
                    <g:form url="[resource: emsApplicantDocumentInstance, action: 'update']" method="PUT" >
                        <div class="box-body">
                            <g:hiddenField name="version" value="${emsApplicantDocumentInstance?.version}" />
                            <g:render template="form" model="${[emsApplicantDocumentInstance:emsApplicantDocumentInstance]}"/>
                        </div><!-- /.box-body -->
                        <div class="box-footer">
                            <fieldset class="buttons">
                                ...
                                <sec:access url="/emsApplicantDocument/show/${emsApplicantDocumentInstance?.id}">
                                    <g:link class="btn btn-warning pull-right" action="show" id="${emsApplicantDocumentInstance?.id}"><i class="fa fa-reply-all" aria-hidden="true"></i> ${message(code: "default.button.goBack.label", default: "Go Back")}</g:link>
                                </sec:access>
                            </fieldset>
                        </div><!-- /.box-footer -->
                    </g:form>
