    ...
    <body>
        <div class="content-wrapper"><!-- Content Wrapper. Contains page content -->
            ...
            <section class="content"><!-- Main content -->
                <div id="edit-authRequestMap" class="box box-primary" role="main">
                        ...
                        <div class="box-footer">
                            <fieldset class="buttons">
                                ...
                                <sec:access url="/authRequestMap/show/${authRequestMapInstance?.id}">
                                    <g:link class="btn btn-warning pull-right" action="show" id="${authRequestMapInstance?.id}"><i class="fa fa-reply-all" aria-hidden="true"></i> ${message(code: "default.button.goBack.label", default: "Go Back")}</g:link>
                                </sec:access>
                            </fieldset>
                        </div><!-- /.box-footer -->
                    </g:form>
