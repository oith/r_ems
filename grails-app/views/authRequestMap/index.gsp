                ...
                <div class="box box-primary">
                    <div class="box-body">
                        <table class="table table-bordered table-striped table-hover table-condensed display nowrap th-center th-colored">
                            ...
                            <thead>
                                <tr>
                                    <th>${message(code: 'authRequestMap.url.label', default: 'Url')}</th>
                                    <th>${message(code: 'authRequestMap.configAttribute.label', default: 'Config Attribute')}</th>
                                    <th>${message(code: 'authRequestMap.isActive.label', default: 'Is Active')}</th>
                                    <th>${message(code: 'authRequestMap.httpMethod.label', default: 'Http Method')}</th>
                                        ...
                                        <tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
                                            ...
                                            <td class="center">
                                                ...
                                                <sec:access url="/authRequestMap/delete/${authRequestMapInstance?.id}">
                                                    <g:link class="btn btn-xs btn-danger" action="delete" id="${authRequestMapInstance?.id}" onclick="return confirm('Are you sure you want to delete this record?');">
                        ...
                        <div class="pagination">
                            <g:paginate total="${authRequestMapInstanceCount ?: 0}"/>
                        </div>
                        --}%
