    ...
    <body>
        <div class="content-wrapper"><!-- Content Wrapper. Contains page content -->
            ...
            <section class="content"><!-- Main content -->
                <div id="create-emsStaffAcademicEducationInfo" class="box box-primary" role="main">
                    <g:form url="[resource: emsStaffAcademicEducationInfoInstance, action: 'save']" method="POST" >
                        <div class="box-body">
