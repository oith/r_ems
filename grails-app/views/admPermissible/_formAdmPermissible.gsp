...
%{------------------------------------------------------------------------------------------------------------------------------------------------------------}%
    ...
    <g:each in="${admPermissibleList ?: new org.reflection.adm.AdmPermissible()}" status="i" var="admPermissibleInstance">
        <div class='box box-info admPermissibleDetails'>
            <div class='box-body'>
                ...
                <g:hiddenField name="admPermissible[${i}].id" value="${admPermissibleInstance?.id}"/>
