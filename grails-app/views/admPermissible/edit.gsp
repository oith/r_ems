    ...
    <body>
        <div class="content-wrapper"><!-- Content Wrapper. Contains page content -->
            ...
            <section class="content"><!-- Main content -->
                <div id="edit-admPermissible" class="box box-primary" role="main">
                    <g:form url="[resource: admPermissibleInstance, action: 'update']" method="PUT" >
                        <div class="box-body">
                            <g:hiddenField name="version" value="${admPermissibleInstance?.version}" />
                            <g:render template="form" model="${[admPermissibleInstance:admPermissibleInstance]}"/>
                            <g:render template="formAdmPermissible" model="${[admPermissibleList : admPermissibleInstance?.admPermissible]}"/>
                        </div><!-- /.box-body -->
                        <div class="box-footer">
                            <fieldset class="buttons">
                                ...
                                <sec:access url="/admPermissible/show/${admPermissibleInstance?.id}">
                                    <g:link class="btn btn-warning pull-right" action="show" id="${admPermissibleInstance?.id}"><i class="fa fa-reply-all" aria-hidden="true"></i> ${message(code: "default.button.goBack.label", default: "Go Back")}</g:link>
                                </sec:access>
                            </fieldset>
                        </div><!-- /.box-footer -->
                    </g:form>
