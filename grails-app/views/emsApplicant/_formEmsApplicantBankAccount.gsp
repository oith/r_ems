    ...
    <g:each in="${emsApplicantBankAccountList ?: new org.reflection.ems.EmsApplicantBankAccount()}" status="i" var="emsApplicantBankAccountInstance">
        <div class='box box-info emsApplicantBankAccountDetails'>
            <div class='box-body'>
                ...
                <g:hiddenField name="emsApplicantBankAccount[${i}].id" value="${emsApplicantBankAccountInstance?.id}"/>
                ...
                <div class='col-xs-12 col-sm-6 col-md-4 col-lg-3'>
                    <div class='form-group ${hasErrors(bean: emsApplicantBankAccountInstance, field: 'comBank', 'has-error')} required'>
                        ...
                        <g:select name="emsApplicantBankAccount[${i}].comBank" class="form-control many-to-one" from="${org.reflection.com.ComBank.list()}" value="${emsApplicantBankAccountInstance?.comBank?.id}" optionKey="id" optionValue="title" noSelection="['': 'Select One']" required="required"/>
