            ...
            <div class='box-body'>
                ...
                <div class='col-xs-12 col-sm-6 col-md-4 col-lg-3'>
                    <div class='form-group ${hasErrors(bean: emsApplicantEducationInfoInstance, field: 'emsApplicant', 'has-error')} required'>
                        ...
                        <g:select name="emsApplicantEducationInfo[${i}].emsApplicant" class="form-control many-to-one" from="${org.reflection.ems.EmsApplicant.list()}" value="${emsApplicantEducationInfoInstance?.emsApplicant?.id}" optionKey="id" noSelection="['': 'Select One']" required="required"/>
