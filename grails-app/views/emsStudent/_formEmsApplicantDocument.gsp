            ...
            <div class='box-body'>
                ...
                <div class='col-xs-12 col-sm-6 col-md-4 col-lg-3'>
                    <div class='form-group ${hasErrors(bean: emsApplicantDocumentInstance, field: 'emsApplicant', 'has-error')} required'>
                        ...
                        <g:select name="emsApplicantDocument[${i}].emsApplicant" class="form-control many-to-one" from="${org.reflection.ems.EmsApplicant.list()}" value="${emsApplicantDocumentInstance?.emsApplicant?.id}" optionKey="id" noSelection="['': 'Select One']" required="required"/>
